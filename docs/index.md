...
heroText: Chen's blog
# tagline: 我们最大的弱点在于放弃，想要成功，就要再尝试一次。
tagline: Hello World
# actionText: 立刻进入 →
# actionLink: /web/
pageClass: vdoing-index-class
#bannerBg: /img/home-bg.png # auto => 网格纹背景(有bodyBgImg时无背景)，默认 | none => 无 | '大图地址' | background: 自定义背景样式       提示：如发现文本颜色不适应你的背景时可以到palette.styl修改$bannerTextColor变量
...
<!-- 小熊猫 -->
<!-- <img src="./.vuepress/public/img/panda-waving.png" class="panda no-zoom" style="width: 200px;
    height: 175px;
    opacity: 0.8;
    margin-bottom: -4px;
    padding-bottom: 0px;
